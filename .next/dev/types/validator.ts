...
// Validate ../../../app/api/mock-stream/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/mock-stream">> = Specific
  const handler = {} as typeof import("../../../app/api/mock-stream/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../app/api/stream-model/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/stream-model">> = Specific
  const handler = {} as typeof import("../../../app/api/stream-model/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
