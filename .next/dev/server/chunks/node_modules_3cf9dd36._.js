...
;
;
// src/gateway-image-model-settings.ts
var DEFAULT_MAX_IMAGES_PER_CALL_BY_PROVIDER = {
    bfl: 1
};
function getDefaultMaxImagesPerCallForModel(modelId) {
...
var GatewayImageModel = class {
    ...
    get maxImagesPerCall() {
        var _a8;
        return (_a8 = getDefaultMaxImagesPerCallForModel(this.modelId)) != null ? _a8 : 4;
    }
    get provider() {
        return this.config.provider;
    }
...
;
// src/version.ts
var VERSION = ("TURBOPACK compile-time truthy", 1) ? "2.0.14" : "TURBOPACK unreachable";
// src/gateway-provider.ts
